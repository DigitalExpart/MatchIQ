                ...
                <AnimatePresence>
                  {showTooltip && (
                    <motion.div
                      ...
                      className="absolute top-full left-0 mt-2 bg-white text-gray-900 rounded-xl shadow-2xl p-5 z-50 border border-gray-100 max-w-4xl"
                    >
                      ...
                      <div className="flex flex-wrap gap-x-6 gap-y-2">
                        {tooltipContent.features.map((feature, index) => (
                          <div key={index} className="text-xs flex items-center gap-2 whitespace-nowrap">
