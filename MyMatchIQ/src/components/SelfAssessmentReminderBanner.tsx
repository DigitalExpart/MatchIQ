                ...
                <AnimatePresence>
                  {showTooltip && (
                    <motion.div
                      ...
                      className="absolute top-full left-0 mt-2 w-72 bg-white text-gray-900 rounded-xl shadow-2xl p-4 z-50 border border-gray-100"
                    >
                      <div className="absolute -top-2 left-4 w-4 h-4 bg-white transform rotate-45 border-t border-l border-gray-100"></div>
                      <h4 className="font-semibold text-sm mb-2 text-[#3C2B63]">
