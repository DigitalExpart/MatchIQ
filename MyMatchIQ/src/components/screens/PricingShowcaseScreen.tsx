...
import { PricingShowcase } from '../pricing/PricingShowcase';

interface PricingShowcaseScreenProps {
  onBack: () => void;
}

export function PricingShowcaseScreen({ onBack }: PricingShowcaseScreenProps) {
  return (
