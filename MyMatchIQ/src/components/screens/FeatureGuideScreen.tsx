...
export function FeatureGuideScreen({ onBack, tier }: FeatureGuideScreenProps) {
  ...
  const content: Record<string, any> = {
    en: {
      ...
      introExtended: 'Here you will find a clear guide to each feature: what it does, why it exists, and how to use it with intention.',
      ...
      sections: {
        ...
        singleScan: {
          ...
          whatItIs: 'What it is',
          whatItIsBody: 'A solo compatibility assessment where you answer questions about someone you are evaluating. The assessment is completely private—they never know you completed it, and no data is shared with them. Results are stored only in your account.',
          whyItMatters: 'Why it matters',
          whyItMattersBody: 'Single Scans let you explore compatibility early in the dating process, before you are ready to involve the other person. They are useful for first impressions, early dates, or situations where mutual evaluation is not appropriate. Results help you decide whether to invest more time and emotional energy.',
          howItWorks: 'How it works',
        ...
        community: {
          ...
          whyItMatters: 'Why it matters',
          whyItMattersBody: 'Assessment Community enables you to connect with people who share your interest in intentional, compatibility-first connection. It is not a dating app—it is a mutual evaluation platform where both parties agree to assess alignment before any emotional or social commitment.',
          howItWorks: 'How it works',
        ...
        requests: {
          ...
          whatItIs: 'What it is',
          whatItIsBody: 'A request system for exchanging compatibility passports with others. Incoming requests show you who wants access to your passport (and has shared theirs). Outgoing requests track who you have sent requests to and their response status.',
          whyItMatters: 'Why it matters',
        ...
        connections: {
          ...
          whatItIs: 'What it is',
          whatItIsBody: 'A list of people you have mutually shared passports with. Active connections grant access to comparison tools, AI Coach insights about your compatibility, and mutual reflection prompts. No messaging or free-text chat is included.',
          whyItMatters: 'Why it matters',
          whyItMattersBody: 'Active connections represent ongoing compatibility evaluation relationships. They are not "matches" or dates—they are structured assessment partnerships. This feature helps you track who has access to your passport and what insights you have unlocked together.',
          howItWorks: 'How it works',
        ...
        reflection: {
          ...
          whyItMatters: 'Why it matters',
          whyItMattersBody: 'Relationships and self-understanding evolve. What mattered six months ago might matter less now. Reflection Weeks ensure your passport stays current, your compatibility insights remain accurate, and you are aware of how you are changing as you date and grow.',
          howItWorks: 'How it works',
        ...
        privacy: {
          ...
          whyItMatters: 'Why it matters',
          whyItMattersBody: 'Trust requires transparency. You need to know what is shared, with whom, and for how long. MyMatchIQ is built on the principle that compatibility evaluation is private, consensual, and protective of your emotional and informational boundaries.',
          howItWorks: 'How it works',
    ...
    es: {
      ...
      sections: {
        ...
        connections: {
          ...
          howItWorks: 'Cómo funciona',
          howItWorksBody: 'Una vez que se acepta una solicitud de pasaporte, la conexión se activa. Puedes ver desgloses de compatibilidad, comparar respuestas y acceder a orientación del Coach IA sobre tu alineación. Las conexiones caducan automáticamente después de 30 días o pueden pausarse o revocarse manualmente.',
          accessLimits: 'Acceso y límites',
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 pb-20">
        ...
        <div className="mb-16 p-6 bg-gradient-to-br from-rose-50 to-purple-50 rounded-2xl border border-rose-100">
          ...
          <ul className="space-y-2 mb-4">
            {currentContent.philosophyPoints.map((point: string, index: number) => (
